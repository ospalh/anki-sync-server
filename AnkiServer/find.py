...
# TODO: Make a patch against Anki and get a non-hack solution in
# anki.find.Finder
class Finder(anki.find.Finder):
    """
    A sub-class of anki.find.Finder with limit and offset.

    A sub-class of anki.find.Finder that hacks in support for
    limit/offset in findCards().
    """
    limit = 0
    offset = 0
